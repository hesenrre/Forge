...
public class Link_to_remote
    ...
    doStartTag(){
        try{
            ...
            writer.println("<a href=\"#\""+getModifiers()+" onClick=\""+ (is_empty(getConfirm()) ? "" : "!confirm('"+getConfirm()+"') ? '':") +"new Ajax.Updater('"+getUpdate()+"','"+getUrl()+"',{asynchronous:true, evalScripts:true}); return false;\">");
